...
public class BookService {
	...
	public Book modifyBook(Long id, Book book) {
		...
		Book bookEntitiy = bookRepository.findById(id).orElseThrow(()->new IllegalArgumentException("id를 확인해주세요!"));
		bookEntitiy.setTitle(book.getTitle());
		bookEntitiy.setAuthor(book.getAuthor());
		bookRepository.save(bookEntitiy);
